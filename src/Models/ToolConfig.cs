...
public sealed class ToolConfig
{
    ...
    public string Org { get; set; } = "ShipMvp";
    public string ShipMvpRepo { get; set; } = "https://github.com/ShipMvp/shipmvp";
    public string ShipMvpBranch { get; set; } = "stable";
    public string FrontendRepo { get; set; } = "https://github.com/ShipMvp/shipmvp-react";
